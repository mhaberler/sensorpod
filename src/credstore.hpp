...
private:
  static constexpr const char *prefNamespace() { return "wifi-creds"; }

  static constexpr const char *keySsid() { return "ssid"; }

  static constexpr const char *keyPass() { return "password"; }
};
...
inline void clearWiFiCredentials() { CredStore::clearWiFiCredentials(); }
